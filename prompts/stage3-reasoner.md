...
prompt, with the repository checked out and the runs/ directory populated.

Keep this file and the SKILL.md in step -- two copies of one prompt diverge,
and a stage-3 bake-off between two reasoners is void the moment they were
