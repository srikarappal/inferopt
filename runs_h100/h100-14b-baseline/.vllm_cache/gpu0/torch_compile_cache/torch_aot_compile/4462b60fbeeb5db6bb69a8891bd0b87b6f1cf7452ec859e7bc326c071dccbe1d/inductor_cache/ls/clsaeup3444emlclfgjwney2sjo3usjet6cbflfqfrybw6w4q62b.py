...
# kernel path: runs/h100-14b-baseline/.vllm_cache/gpu0/torch_compile_cache/torch_aot_compile/4462b60fbeeb5db6bb69a8891bd0b87b6f1cf7452ec859e7bc326c071dccbe1d/inductor_cache/i5/ci5xjyltresuvyy7y2ounq4hqm3xmeljsl6lzrzf2lqmtnsdewi3.py
...
# Graph fragment:
#   %mm : Tensor "bf16[s72, 5120][5120, 1]cuda:0" = PlaceHolder[target=mm]
#   %arg4_1 : Tensor "bf16[s72, 5120][5120, 1]cuda:0" = PlaceHolder[target=arg4_1]
#   %buf1 : Tensor "f32[s72, 1][1, s72]cuda:0" = PlaceHolder[target=buf1]
#   %arg3_1 : Tensor "bf16[5120][1]cuda:0" = PlaceHolder[target=arg3_1]
#   %convert_element_type_default_8 : Tensor "f32[s72, 5120][5120, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mm, torch.float32), kwargs = {})
#   %convert_element_type_default_9 : Tensor "f32[s72, 5120][5120, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%arg4_1, torch.float32), kwargs = {})
#   %add_tensor_4 : Tensor "f32[s72, 5120][5120, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%convert_element_type_default_8, %convert_element_type_default_9), kwargs = {})
#   %pow_tensor_scalar_3 : Tensor "f32[s72, 5120][5120, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%add_tensor_4, 2), kwargs = {})
...
#   %mul_tensor_6 : Tensor "f32[s72, 5120][5120, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_tensor_4, %rsqrt_default_3), kwargs = {})
#   %convert_element_type_default_11 : Tensor "bf16[s72, 5120][5120, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_tensor_6, torch.bfloat16), kwargs = {})
#   %mul_tensor_7 : Tensor "bf16[s72, 5120][5120, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_default_11, %arg3_1), kwargs = {})
...
# kernel path: runs/h100-14b-baseline/.vllm_cache/gpu0/torch_compile_cache/torch_aot_compile/4462b60fbeeb5db6bb69a8891bd0b87b6f1cf7452ec859e7bc326c071dccbe1d/inductor_cache/ns/cnszkyeutvo4v5ligpmmrnwzkira2pz6wlwr5ndp5ifh2iny7o7p.py
...
# Graph fragment:
#   %mm_1 : Tensor "bf16[s72, 34816][34816, 1]cuda:0" = PlaceHolder[target=mm_1]
#   %slice_1 : Tensor "bf16[s72, 17408][34816, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%mm_1, 1, 0, 17408), kwargs = {})
#   %convert_element_type_4 : Tensor "f32[s72, 17408][17408, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%slice_1, torch.float32), kwargs = {})
#   %neg : Tensor "f32[s72, 17408][17408, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.neg.default](args = (%convert_element_type_4,), kwargs = {})
#   %exp : Tensor "f32[s72, 17408][17408, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.exp.default](args = (%neg,), kwargs = {})
#   %add_18 : Tensor "f32[s72, 17408][17408, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%exp, 1), kwargs = {})
#   %div : Tensor "f32[s72, 17408][17408, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%convert_element_type_4, %add_18), kwargs = {})
#   %convert_element_type_5 : Tensor "bf16[s72, 17408][17408, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%div, torch.bfloat16), kwargs = {})
#   %slice_2 : Tensor "bf16[s72, 17408][34816, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%mm_1, 1, 17408, 9223372036854775807), kwargs = {})
#   %mul_16 : Tensor "bf16[s72, 17408][17408, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_5, %slice_2), kwargs = {})
#   return %mul_16
...
# kernel path: runs/h100-14b-baseline/.vllm_cache/gpu0/torch_compile_cache/torch_aot_compile/4462b60fbeeb5db6bb69a8891bd0b87b6f1cf7452ec859e7bc326c071dccbe1d/inductor_cache/ct/cctz5abfwfrjosf7e54s3a3vvkxj3yjlpz37toek4k3bhul6au7u.py
...
# Graph fragment:
#   %mm_2 : Tensor "bf16[s72, 5120][5120, 1]cuda:0" = PlaceHolder[target=mm_2]
#   %mm : Tensor "bf16[s72, 5120][5120, 1]cuda:0" = PlaceHolder[target=mm]
#   %arg4_1 : Tensor "bf16[s72, 5120][5120, 1]cuda:0" = PlaceHolder[target=arg4_1]
...
#   %convert_element_type_default_9 : Tensor "f32[s72, 5120][5120, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%arg4_1, torch.float32), kwargs = {})
#   %add_tensor_4 : Tensor "f32[s72, 5120][5120, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%convert_element_type_default_8, %convert_element_type_default_9), kwargs = {})
#   %convert_element_type_default_10 : Tensor "bf16[s72, 5120][5120, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_tensor_4, torch.bfloat16), kwargs = {})
#   %convert_element_type_default_4 : Tensor "f32[s72, 5120][5120, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mm_2, torch.float32), kwargs = {})
#   %convert_element_type_default_5 : Tensor "f32[s72, 5120][5120, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%convert_element_type_default_10, torch.float32), kwargs = {})
#   %add_tensor_2 : Tensor "f32[s72, 5120][5120, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%convert_element_type_default_4, %convert_element_type_default_5), kwargs = {})
#   %convert_element_type_default_6 : Tensor "bf16[s72, 5120][5120, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_tensor_2, torch.bfloat16), kwargs = {})
#   %pow_tensor_scalar_2 : Tensor "f32[s72, 5120][5120, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%add_tensor_2, 2), kwargs = {})
...
#   %mul_tensor_4 : Tensor "f32[s72, 5120][5120, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_tensor_2, %rsqrt_default_2), kwargs = {})
#   %convert_element_type_default_7 : Tensor "bf16[s72, 5120][5120, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_tensor_4, torch.bfloat16), kwargs = {})
#   %mul_tensor_5 : Tensor "bf16[s72, 5120][5120, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_default_7, %arg7_1), kwargs = {})
...
def triton_red_fused_fused_add_rms_norm_2(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr1, out_ptr2, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    ...
    for r0_offset in tl.range(0, r0_numel, R0_BLOCK):
        ...
        rindex = r0_index
        r0_1 = r0_index
        tmp15 = tl.load(in_ptr0 + (r0_1 + 5120*x0), r0_mask & xmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        tmp17 = tl.load(in_ptr1 + (r0_1 + 5120*x0), r0_mask & xmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        tmp19 = tl.load(in_ptr2 + (r0_1 + 5120*x0), r0_mask & xmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        ...
        tmp33 = tmp31 * tmp32
        tl.store(out_ptr2 + (r0_1 + 5120*x0), tmp33, r0_mask & xmask)
''', device_str='cuda')


# kernel path: runs/h100-14b-baseline/.vllm_cache/gpu0/torch_compile_cache/torch_aot_compile/4462b60fbeeb5db6bb69a8891bd0b87b6f1cf7452ec859e7bc326c071dccbe1d/inductor_cache/me/cmesgmlxgwh7wbbu6qxztumjxb66lxuetpmzdchgwta2i3lelsk6.py
...
# kernel path: runs/h100-14b-baseline/.vllm_cache/gpu0/torch_compile_cache/torch_aot_compile/4462b60fbeeb5db6bb69a8891bd0b87b6f1cf7452ec859e7bc326c071dccbe1d/inductor_cache/ji/cjicy6tqrlsdaxyirblh3un3o7wzrdwglct5epf5pvs45owagu5z.py
# Unsorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
...
with torch.cuda._DeviceGuard(0):
    triton_red_fused_fused_add_rms_norm_0.run(buf0, arg4_1, arg3_1, buf2, 8192, 5120, stream=stream0)
del arg3_1, buf2

stream0 = get_raw_stream(0)
buf3 = generate_example_value((8192, 34816), (34816, 1), 'cuda:0', torch.bfloat16, 0, (8192, 34816))
buf4 = generate_example_value((8192, 17408), (17408, 1), 'cuda:0', torch.bfloat16, 0, (8192, 17408))
with torch.cuda._DeviceGuard(0):
    triton_poi_fused_mul_silu_slice_1.run(buf3, buf4, 142606336, stream=stream0)
del buf3, buf4
...
buf8 = generate_example_value((8192, 5120), (5120, 1), 'cuda:0', torch.bfloat16, 0, (8192, 5120))
with torch.cuda._DeviceGuard(0):
    triton_red_fused_fused_add_rms_norm_2.run(buf5, buf0, arg4_1, arg7_1, buf6, buf8, 8192, 5120, stream=stream0)
del buf0, arg4_1, buf5, arg7_1, buf6, buf8

stream0 = get_raw_stream(0)
buf9 = generate_example_value((8192, 7168), (7168, 1), 'cuda:0', torch.bfloat16, 0, (8192, 7168))
buf10 = generate_example_value((8192, 40, 1), (40, 1, 327680), 'cuda:0', torch.float32, 0, (8192, 40, 1))
buf11 = generate_example_value((8192, 8, 1), (8, 1, 65536), 'cuda:0', torch.float32, 0, (8192, 8, 1))
with torch.cuda._DeviceGuard(0):
    triton_red_fused_3.run(buf9, buf10, buf11, 327680, 65536, stream=stream0)

stream0 = get_raw_stream(0)
arg10_1 = generate_example_value((128,), (1,), 'cuda:0', torch.bfloat16, 0, (128,))
arg11_1 = generate_example_value((8192,), (1,), 'cuda:0', torch.int64, 0, (8192,))
...
buf12 = generate_example_value((8192, 8, 64), (1024, 128, 1), 'cuda:0', torch.bfloat16, 0, (8192, 8, 64))
buf13 = generate_example_value((8192, 8, 64), (1024, 128, 1), 'cuda:0', torch.bfloat16, 0, (8192, 8, 64))
buf15 = generate_example_value((8192, 40, 64), (5120, 128, 1), 'cuda:0', torch.bfloat16, 0, (8192, 40, 64))
buf16 = generate_example_value((8192, 40, 64), (5120, 128, 1), 'cuda:0', torch.bfloat16, 0, (8192, 40, 64))
with torch.cuda._DeviceGuard(0):
    triton_poi_fused_4.run(buf9, buf11, arg10_1, arg11_1, arg12_1, buf10, arg9_1, buf12, buf13, buf15, buf16, 4194304, 20971520, stream=stream0)
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            extern_kernels.mm(reinterpret_tensor(arg0_1, (s72, 5120), (5120, 1), 0), reinterpret_tensor(arg2_1, (5120, 5120), (1, 5120), 0), out=buf0)
            del arg0_1
            del arg2_1
            buf2 = empty_strided_cuda((s72, 5120), (5120, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [fused_add_rms_norm_maybe_inplace], Original ATen: [vllm_ir.fused_add_rms_norm]
            stream0 = get_raw_stream(0)
            triton_red_fused_fused_add_rms_norm_0.run(buf0, arg4_1, arg3_1, buf2, s72, 5120, stream=stream0)
            del arg3_1
            buf3 = empty_strided_cuda((s72, 34816), (34816, 1), torch.bfloat16)
            ...
            extern_kernels.mm(buf2, reinterpret_tensor(arg5_1, (5120, 34816), (1, 5120), 0), out=buf3)
            del arg5_1
            del buf2
            buf4 = empty_strided_cuda((s72, 17408), (17408, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [getitem_2, silu, getitem_3, mul], Original ATen: [aten.slice, aten.silu, aten.mul]
            triton_poi_fused_mul_silu_slice_1_xnumel = 17408*s72
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_silu_slice_1.run(buf3, buf4, triton_poi_fused_mul_silu_slice_1_xnumel, stream=stream0)
            del buf3
            buf5 = empty_strided_cuda((s72, 5120), (5120, 1), torch.bfloat16)
            ...
            extern_kernels.mm(buf4, reinterpret_tensor(arg6_1, (17408, 5120), (1, 17408), 0), out=buf5)
            del arg6_1
            del buf4
            buf6 = empty_strided_cuda((s72, 5120), (5120, 1), torch.bfloat16)
            buf8 = empty_strided_cuda((s72, 5120), (5120, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [fused_add_rms_norm_maybe_inplace, fused_add_rms_norm_maybe_inplace_1], Original ATen: [vllm_ir.fused_add_rms_norm]
            stream0 = get_raw_stream(0)
            triton_red_fused_fused_add_rms_norm_2.run(buf5, buf0, arg4_1, arg7_1, buf6, buf8, s72, 5120, stream=stream0)
            del arg4_1
            del arg7_1
            del buf0
            buf9 = empty_strided_cuda((s72, 7168), (7168, 1), torch.bfloat16)
            ...
            extern_kernels.mm(buf8, reinterpret_tensor(arg8_1, (5120, 7168), (1, 5120), 0), out=buf9)
            del arg8_1
            buf10 = empty_strided_cuda((s72, 40, 1), (40, 1, 40*s72), torch.float32)
            ...
            triton_red_fused_3_xnumel_0 = 40*s72
            ...
            buf17 = reinterpret_tensor(buf8, (s72, 40, 128), (5120, 128, 1), 0); del buf8  # reuse
            buf15 = reinterpret_tensor(buf17, (s72, 40, 64), (5120, 128, 1), 0)  # alias
            buf16 = reinterpret_tensor(buf17, (s72, 40, 64), (5120, 128, 1), 64)  # alias
            # Unsorted Source Nodes: [], Original ATen: []
            triton_poi_fused_4_xnumel_0 = 512*s72
            triton_poi_fused_4_xnumel_1 = 2560*s72
            stream0 = get_raw_stream(0)
        ...
        return (buf14, reinterpret_tensor(buf9, (s72, 8, 128), (7168, 128, 1), 6144), buf17, reinterpret_tensor(buf18, (s72, 40, 128), (5120, 128, 1), 0), buf6, )
...
def get_args():
    from torch._dynamo.testing import rand_strided
    arg0_1 = rand_strided((8192, 40, 128), (5120, 128, 1), device='cuda:0', dtype=torch.bfloat16)
    arg1_1 = 8192
    arg2_1 = rand_strided((5120, 5120), (5120, 1), device='cuda:0', dtype=torch.bfloat16)
    ...
    arg5_1 = rand_strided((34816, 5120), (5120, 1), device='cuda:0', dtype=torch.bfloat16)
    arg6_1 = rand_strided((5120, 17408), (17408, 1), device='cuda:0', dtype=torch.bfloat16)
    arg7_1 = rand_strided((5120, ), (1, ), device='cuda:0', dtype=torch.bfloat16)
    arg8_1 = rand_strided((7168, 5120), (5120, 1), device='cuda:0', dtype=torch.bfloat16)
    ...
    arg11_1 = rand_strided((8192, ), (1, ), device='cuda:0', dtype=torch.int64)
