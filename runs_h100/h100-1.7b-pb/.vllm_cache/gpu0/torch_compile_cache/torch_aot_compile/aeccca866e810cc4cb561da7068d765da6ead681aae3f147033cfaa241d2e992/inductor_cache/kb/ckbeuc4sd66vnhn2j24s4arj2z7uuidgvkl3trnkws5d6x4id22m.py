...
# kernel path: runs/h100-1.7b-pb/.vllm_cache/gpu0/torch_compile_cache/torch_aot_compile/aeccca866e810cc4cb561da7068d765da6ead681aae3f147033cfaa241d2e992/inductor_cache/sa/csa7mjkela3ttsahhtilr5uiqswvppb2jcjm6wpcc7lsshbrgd7j.py
...
# kernel path: runs/h100-1.7b-pb/.vllm_cache/gpu0/torch_compile_cache/torch_aot_compile/aeccca866e810cc4cb561da7068d765da6ead681aae3f147033cfaa241d2e992/inductor_cache/3u/c3ugiy4hgvhiipsntjqxxgzt6zzrb4a74kw3alrkz7takiyjo4s3.py
...
# kernel path: runs/h100-1.7b-pb/.vllm_cache/gpu0/torch_compile_cache/torch_aot_compile/aeccca866e810cc4cb561da7068d765da6ead681aae3f147033cfaa241d2e992/inductor_cache/7v/c7vh3l3vr5nfnm2gv46ph4olln5kfvsu6s7x6ocaqdc2tgdgqrtf.py
...
stream0 = get_raw_stream(0)
buf7 = generate_example_value((2048, 2048), (2048, 1), 'cuda:0', torch.bfloat16, 0, (2048, 2048))
arg7_1 = generate_example_value((2048,), (1,), 'cuda:0', torch.bfloat16, 0, (2048,))
with torch.cuda._DeviceGuard(0):
    triton_red_fused_fused_add_rms_norm_2.run(buf7, buf0, arg4_1, arg7_1, 2048, 2048, stream=stream0)
