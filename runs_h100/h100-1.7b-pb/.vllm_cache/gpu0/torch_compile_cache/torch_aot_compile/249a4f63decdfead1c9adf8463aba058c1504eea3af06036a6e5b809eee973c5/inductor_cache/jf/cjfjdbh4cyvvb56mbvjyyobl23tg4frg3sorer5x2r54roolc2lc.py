...
def get_args():
    ...
    arg_5 = rand_strided((2048, 16, 64), (2048, 128, 1), device='cuda:0', dtype=torch.bfloat16)
    arg_6 = rand_strided((2048, 16, 64), (2048, 128, 1), device='cuda:0', dtype=torch.bfloat16)
    return arg_0, arg_1, arg_2, arg_3, arg_4, arg_5, arg_6, 2097152,
