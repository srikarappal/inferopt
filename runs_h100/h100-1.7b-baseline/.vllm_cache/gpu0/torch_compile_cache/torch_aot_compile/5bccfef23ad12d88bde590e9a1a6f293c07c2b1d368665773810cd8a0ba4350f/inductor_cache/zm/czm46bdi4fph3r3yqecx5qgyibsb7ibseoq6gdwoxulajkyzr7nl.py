...
# kernel path: runs/h100-1.7b-baseline/.vllm_cache/gpu0/torch_compile_cache/torch_aot_compile/5bccfef23ad12d88bde590e9a1a6f293c07c2b1d368665773810cd8a0ba4350f/inductor_cache/nu/cnuxg2zeswhf3dpxx4yofagud2dn7uhno46eqzfma2prjzw2xegn.py
...
# kernel path: runs/h100-1.7b-baseline/.vllm_cache/gpu0/torch_compile_cache/torch_aot_compile/5bccfef23ad12d88bde590e9a1a6f293c07c2b1d368665773810cd8a0ba4350f/inductor_cache/en/cen5gvfjxwgsxy7k5p5rufbj3ggnbxht3kzbf2dhpn5whh6jd2ej.py
...
# kernel path: runs/h100-1.7b-baseline/.vllm_cache/gpu0/torch_compile_cache/torch_aot_compile/5bccfef23ad12d88bde590e9a1a6f293c07c2b1d368665773810cd8a0ba4350f/inductor_cache/2s/c2sbykhxeinlkfkhw4pzllf2alwk653ambm2bpniwskwbfzd4pjt.py
...
# kernel path: runs/h100-1.7b-baseline/.vllm_cache/gpu0/torch_compile_cache/torch_aot_compile/5bccfef23ad12d88bde590e9a1a6f293c07c2b1d368665773810cd8a0ba4350f/inductor_cache/7q/c7qfcsgstf6r4uwdi6ejeokda22xg3zaolbinnlwxcc5dbaaykht.py
...
def get_args():
    ...
    arg_1 = rand_strided((8192, 16, 1), (16, 1, 131072), device='cuda:0', dtype=torch.float32)
    arg_2 = rand_strided((8192, 8, 1), (8, 1, 65536), device='cuda:0', dtype=torch.float32)
    return arg_0, arg_1, arg_2, 131072, 65536,
...
# kernel path: runs/h100-1.7b-baseline/.vllm_cache/gpu0/torch_compile_cache/torch_aot_compile/5bccfef23ad12d88bde590e9a1a6f293c07c2b1d368665773810cd8a0ba4350f/inductor_cache/7v/c7vkytdc5nfzlyvdxyahfsvch6phhg4gppsi5fsoufaglzokr32f.py
# Unsorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
...
@triton_heuristics.pointwise(
    size_hints={'x': 8388608}, tile_hint=TileHint.DEFAULT,
    filename=__file__,
...
def get_args():
    ...
    arg_5 = rand_strided((8192, 16, 1), (16, 1, 131072), device='cuda:0', dtype=torch.float32)
    ...
    arg_9 = rand_strided((8192, 16, 64), (2048, 128, 1), device='cuda:0', dtype=torch.bfloat16)
    arg_10 = rand_strided((8192, 16, 64), (2048, 128, 1), device='cuda:0', dtype=torch.bfloat16)
    return arg_0, arg_1, arg_2, arg_3, arg_4, arg_5, arg_6, arg_7, arg_8, arg_9, arg_10, 4194304, 8388608,
...
buf10 = generate_example_value((8192, 16, 1), (16, 1, 131072), 'cuda:0', torch.float32, 0, (8192, 16, 1))
buf11 = generate_example_value((8192, 8, 1), (8, 1, 65536), 'cuda:0', torch.float32, 0, (8192, 8, 1))
with torch.cuda._DeviceGuard(0):
    triton_red_fused_3.run(buf9, buf10, buf11, 131072, 65536, stream=stream0)
...
buf15 = generate_example_value((8192, 16, 64), (2048, 128, 1), 'cuda:0', torch.bfloat16, 0, (8192, 16, 64))
buf16 = generate_example_value((8192, 16, 64), (2048, 128, 1), 'cuda:0', torch.bfloat16, 0, (8192, 16, 64))
with torch.cuda._DeviceGuard(0):
    triton_poi_fused_4.run(buf9, buf11, arg10_1, arg11_1, arg12_1, buf10, arg9_1, buf12, buf13, buf15, buf16, 4194304, 8388608, stream=stream0)
