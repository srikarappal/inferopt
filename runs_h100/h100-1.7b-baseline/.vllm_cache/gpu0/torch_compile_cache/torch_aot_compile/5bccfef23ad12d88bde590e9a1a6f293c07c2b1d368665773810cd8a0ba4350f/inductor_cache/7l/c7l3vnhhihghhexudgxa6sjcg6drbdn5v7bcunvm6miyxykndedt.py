...
# kernel path: runs/h100-1.7b-baseline/.vllm_cache/gpu0/torch_compile_cache/torch_aot_compile/5bccfef23ad12d88bde590e9a1a6f293c07c2b1d368665773810cd8a0ba4350f/inductor_cache/jn/cjngnb5yiwso2utrmpuw4bqygicsvb4fdowej4yj4a4znlol73ey.py
...
# kernel path: runs/h100-1.7b-baseline/.vllm_cache/gpu0/torch_compile_cache/torch_aot_compile/5bccfef23ad12d88bde590e9a1a6f293c07c2b1d368665773810cd8a0ba4350f/inductor_cache/6e/c6eu2ce73q5yuoonuctawwztdi4nicznrbefdf5fsgq7rt2jjrb3.py
...
# kernel path: runs/h100-1.7b-baseline/.vllm_cache/gpu0/torch_compile_cache/torch_aot_compile/5bccfef23ad12d88bde590e9a1a6f293c07c2b1d368665773810cd8a0ba4350f/inductor_cache/pk/cpkbwpnixwfnaeuveolaeleaad7xhytj5226u7pesdfwwj6ygfh6.py
# Unsorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
...
buf4 = generate_example_value((8192, 16, 1), (16, 1, 131072), 'cuda:0', torch.float32, 0, (8192, 16, 1))
buf5 = generate_example_value((8192, 8, 1), (8, 1, 65536), 'cuda:0', torch.float32, 0, (8192, 8, 1))
with torch.cuda._DeviceGuard(0):
    triton_red_fused_1.run(buf3, buf4, buf5, 131072, 65536, stream=stream0)
...
buf9 = generate_example_value((8192, 16, 64), (2048, 128, 1), 'cuda:0', torch.bfloat16, 0, (8192, 16, 64))
buf10 = generate_example_value((8192, 16, 64), (2048, 128, 1), 'cuda:0', torch.bfloat16, 0, (8192, 16, 64))
with torch.cuda._DeviceGuard(0):
    triton_poi_fused_2.run(buf3, buf5, arg6_1, arg7_1, arg8_1, buf4, arg5_1, buf6, buf7, buf9, buf10, 4194304, 8388608, stream=stream0)
