...
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    ...
    x2 = xindex // 1024
    x3 = xindex // 64
    tmp0 = tl.load(in_ptr0 + (x0 + 128*x1 + 4096*x2), xmask).to(tl.float32)
    ...
    tmp20 = tl.load(in_ptr0 + (64 + x0 + 128*x1 + 4096*x2), xmask).to(tl.float32)
...
def get_args():
    ...
    arg_5 = rand_strided((8192, 16, 64), (2048, 128, 1), device='cuda:0', dtype=torch.bfloat16)
    arg_6 = rand_strided((8192, 16, 64), (2048, 128, 1), device='cuda:0', dtype=torch.bfloat16)
    return arg_0, arg_1, arg_2, arg_3, arg_4, arg_5, arg_6, 8388608,
