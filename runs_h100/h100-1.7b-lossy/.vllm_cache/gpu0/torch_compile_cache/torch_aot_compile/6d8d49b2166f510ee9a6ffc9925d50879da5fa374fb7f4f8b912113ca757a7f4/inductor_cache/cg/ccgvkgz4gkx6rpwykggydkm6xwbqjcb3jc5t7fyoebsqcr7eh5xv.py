...
# kernel path: runs/h100-1.7b-lossy/.vllm_cache/gpu0/torch_compile_cache/torch_aot_compile/6d8d49b2166f510ee9a6ffc9925d50879da5fa374fb7f4f8b912113ca757a7f4/inductor_cache/nu/cnuxg2zeswhf3dpxx4yofagud2dn7uhno46eqzfma2prjzw2xegn.py
...
# kernel path: runs/h100-1.7b-lossy/.vllm_cache/gpu0/torch_compile_cache/torch_aot_compile/6d8d49b2166f510ee9a6ffc9925d50879da5fa374fb7f4f8b912113ca757a7f4/inductor_cache/en/cen5gvfjxwgsxy7k5p5rufbj3ggnbxht3kzbf2dhpn5whh6jd2ej.py
...
# kernel path: runs/h100-1.7b-lossy/.vllm_cache/gpu0/torch_compile_cache/torch_aot_compile/6d8d49b2166f510ee9a6ffc9925d50879da5fa374fb7f4f8b912113ca757a7f4/inductor_cache/2s/c2sbykhxeinlkfkhw4pzllf2alwk653ambm2bpniwskwbfzd4pjt.py
...
# kernel path: runs/h100-1.7b-lossy/.vllm_cache/gpu0/torch_compile_cache/torch_aot_compile/6d8d49b2166f510ee9a6ffc9925d50879da5fa374fb7f4f8b912113ca757a7f4/inductor_cache/hg/chgkkcfrxjg5yvx6lifctfjevxqcb7jjxg6xatoo6k4n7ui7o2af.py
...
# kernel path: runs/h100-1.7b-lossy/.vllm_cache/gpu0/torch_compile_cache/torch_aot_compile/6d8d49b2166f510ee9a6ffc9925d50879da5fa374fb7f4f8b912113ca757a7f4/inductor_cache/zj/czjhuanxkde5z2hjvrrwiza2ptkblafpd6ak3e6yjj24nzyljnhc.py
# Topologically Sorted Source Nodes: [split, index_select, chunk, view_3, rms_norm_default_1, chunk_2, unsqueeze_2, mul_5, unsqueeze_3, mul_6, sub_1, mul_7, mul_8, add_1], Original ATen: [aten.split_with_sizes, aten.index_select, aten.split, aten.view, vllm_ir.rms_norm, aten.unsqueeze, aten.mul, aten.sub, aten.add]
# Source node to ATen node mapping:
#   add_1 => add_188
#   chunk => split
#   chunk_2 => split_2
...
#   view_3 => view_3
# Graph fragment:
#   %mm_3 : Tensor "bf16[s72, 4096][4096, 1]cuda:0" = PlaceHolder[target=mm_3]
#   %buf11 : Tensor "f32[s72, 8, 1][8, 1, 8*s72]cuda:0" = PlaceHolder[target=buf11]
#   %arg10_1 : Tensor "bf16[128][1]cuda:0" = PlaceHolder[target=arg10_1]
#   %arg11_1 : Tensor "i64[s72][1]cuda:0" = PlaceHolder[target=arg11_1]
#   %arg12_1 : Tensor "bf16[40960, 128][128, 1]cuda:0" = PlaceHolder[target=arg12_1]
#   %split_with_sizes : [num_users=3] = call_function[target=torch.ops.aten.split_with_sizes.default](args = (%mm_3, [2048, 1024, 1024], -1), kwargs = {})
...
#   %view_3 : Tensor "bf16[s72, 8, 128][4096, 128, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%getitem_5, [%arg1_1, 8, 128]), kwargs = {})
#   %convert_element_type_default : Tensor "f32[s72, 8, 128][1024, 128, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_3, torch.float32), kwargs = {})
...
#   %mul_tensor_1 : Tensor "bf16[s72, 8, 128][1024, 128, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_default_1, %arg10_1), kwargs = {})
#   %split_2 : [num_users=2] = call_function[target=torch.ops.aten.split.Tensor](args = (%mul_tensor_1, 64, -1), kwargs = {})
#   %unsqueeze_2 : Tensor "bf16[s72, 1, 64][128, 64, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%getitem_7, -2), kwargs = {})
#   %mul_105 : Tensor "bf16[s72, 8, 64][512, 64, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%getitem_11, %unsqueeze_2), kwargs = {})
#   %unsqueeze_3 : Tensor "bf16[s72, 1, 64][128, 64, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%getitem_8, -2), kwargs = {})
#   %mul_108 : Tensor "bf16[s72, 8, 64][512, 64, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%getitem_12, %unsqueeze_3), kwargs = {})
#   %sub_51 : Tensor "bf16[s72, 8, 64][512, 64, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mul_105, %mul_108), kwargs = {})
#   %mul_113 : Tensor "bf16[s72, 8, 64][512, 64, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%getitem_12, %unsqueeze_2), kwargs = {})
#   %mul_116 : Tensor "bf16[s72, 8, 64][512, 64, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%getitem_11, %unsqueeze_3), kwargs = {})
#   %add_188 : Tensor "bf16[s72, 8, 64][512, 64, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_113, %mul_116), kwargs = {})
#   return %sub_51,%add_188
triton_poi_fused_add_index_select_mul_rms_norm_split_split_with_sizes_sub_unsqueeze_view_4 = async_compile.triton('triton_poi_fused_add_index_select_mul_rms_norm_split_split_with_sizes_sub_unsqueeze_view_4', '''
import triton
import triton.language as tl
...
arg4_1 = generate_example_value((8192, 2048), (2048, 1), 'cuda:0', torch.bfloat16, 0, (8192, 2048))
...
with torch.cuda._DeviceGuard(0):
    triton_red_fused_fused_add_rms_norm_0.run(buf0, arg4_1, arg3_1, buf2, 8192, 2048, stream=stream0)
del arg3_1, buf2

stream0 = get_raw_stream(0)
buf3 = generate_example_value((8192, 12288), (12288, 1), 'cuda:0', torch.bfloat16, 0, (8192, 12288))
buf4 = generate_example_value((8192, 6144), (6144, 1), 'cuda:0', torch.bfloat16, 0, (8192, 6144))
with torch.cuda._DeviceGuard(0):
    triton_poi_fused_mul_silu_slice_1.run(buf3, buf4, 50331648, stream=stream0)
del buf3, buf4

stream0 = get_raw_stream(0)
buf5 = generate_example_value((8192, 2048), (2048, 1), 'cuda:0', torch.bfloat16, 0, (8192, 2048))
arg7_1 = generate_example_value((2048,), (1,), 'cuda:0', torch.bfloat16, 0, (2048,))
buf6 = generate_example_value((8192, 2048), (2048, 1), 'cuda:0', torch.bfloat16, 0, (8192, 2048))
buf8 = generate_example_value((8192, 2048), (2048, 1), 'cuda:0', torch.bfloat16, 0, (8192, 2048))
with torch.cuda._DeviceGuard(0):
    triton_red_fused_fused_add_rms_norm_2.run(buf5, buf0, arg4_1, arg7_1, buf6, buf8, 8192, 2048, stream=stream0)
del buf0, arg4_1, buf5, arg7_1, buf6, buf8

stream0 = get_raw_stream(0)
buf9 = generate_example_value((8192, 4096), (4096, 1), 'cuda:0', torch.bfloat16, 0, (8192, 4096))
...
arg13_1 = generate_example_value((), (), 'cuda:0', torch.float32, 0, ())
buf16 = generate_example_value((8192, 2048), (2048, 1), 'cuda:0', torch.float8_e4m3fn, 0, (8192, 2048))
buf11 = generate_example_value((8192, 8, 1), (8, 1, 65536), 'cuda:0', torch.float32, 0, (8192, 8, 1))
with torch.cuda._DeviceGuard(0):
    triton_red_fused_3.run(buf9, arg9_1, arg11_1, arg12_1, arg13_1, buf16, buf11, 131072, 65536, stream=stream0)
del arg9_1, arg13_1, buf16
...
with torch.cuda._DeviceGuard(0):
    triton_poi_fused_add_index_select_mul_rms_norm_split_split_with_sizes_sub_unsqueeze_view_4.run(buf9, buf11, arg10_1, arg11_1, arg12_1, buf12, buf13, 65536, 64, stream=stream0)
del buf9, arg11_1, arg12_1, buf11, arg10_1, buf12, buf13
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            del arg8_1
            buf16 = empty_strided_cuda((s72, 2048), (2048, 1), torch.float8_e4m3fn)
            buf11 = empty_strided_cuda((s72, 8, 1), (8, 1, 8*s72), torch.float32)
            # Topologically Sorted Source Nodes: [split, view_3, rms_norm_default_1], Original ATen: [aten.split_with_sizes, aten.view, vllm_ir.rms_norm]
            triton_red_fused_3_xnumel_0 = 16*s72
            triton_red_fused_3_xnumel_1 = 8*s72
            stream0 = get_raw_stream(0)
            triton_red_fused_3.run(buf9, arg9_1, arg11_1, arg12_1, arg13_1, buf16, buf11, triton_red_fused_3_xnumel_0, triton_red_fused_3_xnumel_1, stream=stream0)
            del arg13_1
            del arg9_1
            ...
            # Topologically Sorted Source Nodes: [split, index_select, chunk, view_3, rms_norm_default_1, chunk_2, unsqueeze_2, mul_5, unsqueeze_3, mul_6, sub_1, mul_7, mul_8, add_1], Original ATen: [aten.split_with_sizes, aten.index_select, aten.split, aten.view, vllm_ir.rms_norm, aten.unsqueeze, aten.mul, aten.sub, aten.add]
            triton_poi_fused_add_index_select_mul_rms_norm_split_split_with_sizes_sub_unsqueeze_view_4_ynumel = 8*s72
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_index_select_mul_rms_norm_split_split_with_sizes_sub_unsqueeze_view_4.run(buf9, buf11, arg10_1, arg11_1, arg12_1, buf12, buf13, triton_poi_fused_add_index_select_mul_rms_norm_split_split_with_sizes_sub_unsqueeze_view_4_ynumel, 64, stream=stream0)
            del arg10_1
            del arg11_1
            del arg12_1
            del buf11
            buf17 = buf8; del buf8  # reuse
        return (buf14, reinterpret_tensor(buf9, (s72, 8, 128), (4096, 128, 1), 3072), reinterpret_tensor(buf16, (s72, 16, 128), (2048, 128, 1), 0), reinterpret_tensor(buf17, (s72, 16, 128), (2048, 128, 1), 0), buf6, )
...
def get_args():
    from torch._dynamo.testing import rand_strided
    arg0_1 = rand_strided((8192, 16, 128), (2048, 128, 1), device='cuda:0', dtype=torch.bfloat16)
    arg1_1 = 8192
    ...
    arg4_1 = rand_strided((8192, 2048), (2048, 1), device='cuda:0', dtype=torch.bfloat16)
