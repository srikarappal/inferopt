...
# kernel path: runs/h100-1.7b-lossy/.vllm_cache/gpu0/torch_compile_cache/torch_aot_compile/ae9d8695b83ae6b846ddaf7b84757a0e6c9f6fac9aa02493bd0f4c243e85cf80/inductor_cache/rp/crpcwxledl5e3sd3odo5a255jjsp7n33xttwf3pewjn2ailujyk3.py
...
# kernel path: runs/h100-1.7b-lossy/.vllm_cache/gpu0/torch_compile_cache/torch_aot_compile/ae9d8695b83ae6b846ddaf7b84757a0e6c9f6fac9aa02493bd0f4c243e85cf80/inductor_cache/q6/cq624prwtdvrjc65oy3osok2jzg5wleui75brd3jn4iuvorcknnn.py
...
# kernel path: runs/h100-1.7b-lossy/.vllm_cache/gpu0/torch_compile_cache/torch_aot_compile/ae9d8695b83ae6b846ddaf7b84757a0e6c9f6fac9aa02493bd0f4c243e85cf80/inductor_cache/vp/cvp2xowwuv6thohugfvdpo4txv37xxnrvk336y6d7p4whv3p5ryn.py
# Unsorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
...
with torch.cuda._DeviceGuard(0):
    triton_red_fused__to_copy_embedding_rms_norm_0.run(arg0_1, arg2_1, arg3_1, buf0, buf2, 2048, 2048, stream=stream0)
del arg0_1, arg2_1, arg3_1, buf0, buf2

stream0 = get_raw_stream(0)
buf3 = generate_example_value((2048, 4096), (4096, 1), 'cuda:0', torch.bfloat16, 0, (2048, 4096))
buf4 = generate_example_value((2048, 16, 1), (16, 1, 32768), 'cuda:0', torch.float32, 0, (2048, 16, 1))
buf5 = generate_example_value((2048, 8, 1), (8, 1, 16384), 'cuda:0', torch.float32, 0, (2048, 8, 1))
with torch.cuda._DeviceGuard(0):
    triton_red_fused_1.run(buf3, buf4, buf5, 32768, 16384, stream=stream0)
...
buf6 = generate_example_value((2048, 8, 64), (1024, 128, 1), 'cuda:0', torch.bfloat16, 0, (2048, 8, 64))
buf7 = generate_example_value((2048, 8, 64), (1024, 128, 1), 'cuda:0', torch.bfloat16, 0, (2048, 8, 64))
buf9 = generate_example_value((2048, 16, 64), (2048, 128, 1), 'cuda:0', torch.bfloat16, 0, (2048, 16, 64))
buf10 = generate_example_value((2048, 16, 64), (2048, 128, 1), 'cuda:0', torch.bfloat16, 0, (2048, 16, 64))
with torch.cuda._DeviceGuard(0):
    triton_poi_fused_2.run(buf3, buf5, arg6_1, arg7_1, arg8_1, buf4, arg5_1, buf6, buf7, buf9, buf10, 1048576, 2097152, stream=stream0)
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            del arg4_1
            del buf2
            buf4 = empty_strided_cuda((s72, 16, 1), (16, 1, 16*s72), torch.float32)
            ...
            triton_poi_fused_2_xnumel_1 = 1024*s72
            stream0 = get_raw_stream(0)
        ...
        return (buf8, reinterpret_tensor(buf3, (s72, 8, 128), (4096, 128, 1), 3072), buf11, reinterpret_tensor(buf12, (s72, 16, 128), (2048, 128, 1), 0), buf0, )
